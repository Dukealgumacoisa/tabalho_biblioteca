...
ALTER TABLE `livros` ADD CONSTRAINT `livros_fk0` FOREIGN KEY (`id_livro`) REFERENCES `emprestimo`(`id_livro`);
ALTER TABLE `usuario_admin` ADD CONSTRAINT `usuario_admin_fk0` FOREIGN KEY (`id_admin`) REFERENCES `emprestimo`(`id_admin`);
ALTER TABLE `ususario_alunos` ADD CONSTRAINT `ususario_alunos_fk0` FOREIGN KEY (`id_alunos`) REFERENCES `emprestimo`(`id_aluno`);
ALTER TABLE `usuario_professor` ADD CONSTRAINT `usuario_professor_fk0` FOREIGN KEY (`id_professor`) REFERENCES `emprestimo`(`id_professor`);